...
# sigma = .5 non cambia un granchè - ma la densità stimata è più smooth
# sigma = .8 bene! anche densità
# sigma = 1 bene! anche densità, ma un solo cluster ((???))

# ugly residuals
# sigma=0 --- SCHIFO - forse solo la shape della densità si salva
# sigma=0.5 --- Non bene - forse troppa  variabilità?
## Algorithm
begin = Sys.time()
print(begin)
